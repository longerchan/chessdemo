...
Java_com_jnz_chess_ai_StockfishEngine_nativeInit(JNIEnv* env, jobject thiz, jint ttSizeMB, jint threadCount) {
...
Java_com_jnz_chess_ai_StockfishEngine_nativeSetPosition(JNIEnv* env, jobject thiz,
...
JNIEXPORT jstring JNICALL
Java_com_jnz_chess_ai_StockfishEngine_nativeGo(JNIEnv* env, jobject thiz,
                                               jint depth,
...
Java_com_jnz_chess_ai_StockfishEngine_nativeSetOption(JNIEnv* env, jobject thiz,
...
JNIEXPORT void JNICALL
Java_com_jnz_chess_ai_StockfishEngine_nativeStop(JNIEnv* env, jobject thiz) {
...
JNIEXPORT jstring JNICALL
Java_com_jnz_chess_ai_StockfishEngine_nativeGetLatestInfo(JNIEnv* env, jobject thiz) {
    std::lock_guard<std::mutex> lock(g_info_mutex);
    return env->NewStringUTF(g_latest_info.c_str());
}

JNIEXPORT jstring JNICALL
Java_com_jnz_chess_ai_StockfishEngine_nativeGoInfinite(JNIEnv* env, jobject thiz,
...
JNIEXPORT void JNICALL
Java_com_jnz_chess_ai_StockfishEngine_nativeQuit(JNIEnv* env, jobject thiz) {
    std::lock_guard<std::mutex> lock(g_engine_mutex);
    Engine* eng = g_engine.load(std::memory_order_acquire);
    if (eng) {
        eng->stop();
